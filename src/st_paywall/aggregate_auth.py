...
from .stripe_auth import is_active_subscriber as is_stripe_subscriber
from .stripe_auth import redirect_button
...
def add_auth(
    ...
    if required:
        require_auth(
            show_redirect_button, subscription_button_text, button_color, use_sidebar
        )
    else:
        optional_auth(
            show_redirect_button, subscription_button_text, button_color, use_sidebar
